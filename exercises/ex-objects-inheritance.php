...
<?php
    ...
    echo $employee1->getJobTitle() . "</br>";
    $employee2 = new Employees('Raisa', 'Khan', '11', 'Assistant Planner');
    echo "Employee ID:" . $employee2->getEmployeeId() . "  Last Name:" . $employee2->getLastName() . "  Job Title:" . $employee2->getJobTitle() . "</br>" ;
...
<?php
    ...
    class Shapes{
        public function getPerimeter(){
            echo "This is the Perimeter </br>";
        }

        public function getArea(){
            echo "This is the Area </br>";
        }
    }
    ...
    $circles1 = new Shapes();
    $circles1->getPerimeter();
    $circles1->getArea();

    $circles2 = new Circles(5);
    echo "Perimeter =" . $circles2->getPerimeter() . "</br>";
    echo "Area =" . $circles2->getArea() . "</br>";
?>
